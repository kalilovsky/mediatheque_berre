<template>
  <div class="navigation" :class="{active : toggleDropDownMenu }" @click="toggleDropDownMenu= !toggleDropDownMenu">
    <div class="userBx">
      <div class="imgBx">
